...
class DonerPage extends StatelessWidget {
  const DonerPage({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Text("Last Connected 1 month ago",
                style: TextStyle(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    TwoTexts(
                        "Mailing Address", "9945 Watthem Street,NewYork,USA"),
                    TwoTexts("Company", "Best Buy"),
                    TwoTexts(
                        "Company Address", "3345 Block Rd Ave,Austi TX 78499"),
                  ],
                ),
              ),
            ),
